...
class DataAccessTest {
    ...
    void getStruttura() {
        ...
        StrutturaBean s=new StrutturaBean(1,"santobono","Via della Croce Rossa n. 8 Napoli (NA)","0812205111");
    ...
    void getOperazione() {
        ...
        OperazioneBean o=new OperazioneBean(1,"Pagamento Ticket","Pagamento Ticket per visita medica");
    ...
    void getImpiegato(){
        ...
        Date date=Date.valueOf(str);
        ImpiegatoBean impiegato=new ImpiegatoBean("FLTNGL99A14L845J","angelo99","angelo","afeltra",date,"a.afeltra12@studenti.unisa.it","3394487295",1);
