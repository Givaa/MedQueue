...
public class MostraPrenotazioneAccettataView {
    ...
    public MostraPrenotazioneAccettataView(PrenotazioneBean p){
        ...
        idPrenotazione.setFont(new Font(idPrenotazione.getFont().getName(), idPrenotazione.getFont().getStyle(), 30));
        codicefiscale.setFont(new Font(codicefiscale.getFont().getName(), codicefiscale.getFont().getStyle(), 30));
