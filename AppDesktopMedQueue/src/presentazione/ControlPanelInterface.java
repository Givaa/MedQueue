...
/** Interfaccia che fornisce il pannello di controllo che permettera all'impiegato di accettare prenotazioni. **/
public interface ControlPanelInterface {

    /**
     * Metodo che genera un pannello di controllo che permette all'impiegato di accettare prenotazioni
