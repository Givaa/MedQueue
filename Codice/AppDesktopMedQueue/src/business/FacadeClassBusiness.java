...
public class FacadeClassBusiness {
   ...
   * @return ritorna un oggetto contenente i dati dell'impiegato se l'autenticazione ha successo altrimenti null.
   * @throws InvalidAccesException se il codice fiscale  o la password non rispettano il formato delle credenziali di un impiegato
   */
  ...
  /**
   * Permette di chiedere al sistema di accettare una prenotazione in coda per una determinata struttura
