...
public class DriverManagerConnectionPool {
	...
	private synchronized static Connection createDBConnection() throws SQLException {
		...
		String ip = "localhost";
		String port = "3306";
		String db = "medqueue?serverTimezone=UTC&useLegacyDatetimeCode=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&zeroDateTimeBehavior=convertToNull&autoReconnect=true";
